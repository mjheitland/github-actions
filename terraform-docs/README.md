...
A Github action for generating [Terraform module documentation](https://github.com/terraform-docs/terraform-docs)
using terraform-docs and gomplate.
...
`.github/workflows/terraform-docs.yml`, with the following:
...
jobs:
  docs:
    ...
    - name: Render terraform docs inside the README.md and push changes back to PR branch
      uses: GDP3-AWS/github-actions/terraform-docs@v1
      with:
        working-dir: .
